...
class CelestialObjectDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onClose, // Fermer en cliquant à l'extérieur
      child: Container(
        color: Colors.transparent,
        child: Center(
          child: GestureDetector(
            onTap: () {}, // Empêcher la fermeture lors du clic sur le contenu
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(color: _getObjectColor(), width: 1),
                                ),
                                child: Text(
                                  _getObjectTypeName(),
                                  style: TextStyle(
                    ...
                    _buildInfoCard(
                      ...
                      title: "Coordonnées",
                      children: [
                        _buildInfoRow("Ascension droite", "${object.rightAscension.toStringAsFixed(2)}h"),
                        _buildInfoRow("Déclinaison", "${object.declination.toStringAsFixed(2)}°"),
                      ],
                    ),
                    ...
                    _buildInfoCard(
                      ...
                      children: [
                        ...
                        _buildInfoRow("Taille", "${object.size.toStringAsFixed(2)} km"),
                      ],
                    ),
                    ...
                    Center(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _getObjectColor().withOpacity(0.2),
                          foregroundColor: Colors.white,
                          padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 12),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(25),
                            side: BorderSide(color: _getObjectColor()),
                          ),
                        ),
                        child: const Text(
                          "Fermer",
